...
function TEST()
    -- print(tostring(AshitaCore:GetMemoryManager():GetEntity():GetStatus(AshitaCore:GetMemoryManager():GetParty():GetMemberTargetIndex(0))))
    Message(CheckSpellRecast(enums.san));
end