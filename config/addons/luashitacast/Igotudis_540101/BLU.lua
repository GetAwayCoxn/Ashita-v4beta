...
local sets = {
    ...
    BluSkill = {
        --relic head only if you use it elsewhere (for inv reasons)
        Neck = "Mirage Stole +1",
        Ear2 = "Hashishin Earring",
        Body = "Assim. Jubbah +3",
        Legs = "Hashishin Tayt +2",
        --relic feet only if you use it elsewhere (for inv reasons)
    },
    BluMagical = {
    ...
    BluStun = {--more and more this set is starting to mirror the regular BluMagicAccuracy set
        Ammo = "Pemphredo Tathlum",
        Head = "Hashishin Kavuk +2",
        Neck = "Mirage Stole +1",
        -- Ear1 = "Digni. Earring",--use this after empy+2 full set
        Ear1 = "Regal Earring",
        Ear2 = "Hashishin Earring",
        Body = "Hashishin Mintan +2",
        Hands = "Hashi. Bazu. +2",
    ...
    Ws_Default = {
        ...
        Back = { Name = 'Rosmerta\'s Cape', Augment = { [1] = 'STR+25', [2] = 'Weapon skill damage +10%', [3] = 'Attack+20', [4] = 'Accuracy+20' } },
        Waist = "Fotia Belt",
        Legs = "Luhlaza Shalwar +3",
...
profile.HandleDefault = function()
    ...
    if not gcdisplay.GetToggle("CJmode") then gcinclude.CheckDefault() end
    ...
    if (zone.Area:contains("Remnants")) then gFunc.EquipSet(sets.Salvage) end
end
...
profile.HandlePrecast = function()
    ...
    if string.match(spell.Skill, "Blue Magic") then
...
profile.HandleMidcast = function()
    ...
    if gcdisplay.GetToggle("CJmode") then gFunc.EquipSet(sets.CJmid) end
    if gcinclude.BluMagTH:contains(spell.Name) and gcdisplay.GetToggle("TH") then gFunc.EquipSet(sets.TH) end
end
