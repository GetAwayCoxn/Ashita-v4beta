...
local sets = {
    Idle = {--HP/Meva cape, cactus UNM earring, full bunzi
    ...
    Song_Precast = { --87
        ...
        Back = { Name = 'Intarabus\'s Cape', Augment = { [1] = 'Damage taken-5%', [2] = '"Fast Cast"+10', [3] = 'Mag. Acc.+10', [4] = 'Mag. Acc+20', [5] = 'CHR+20', [6] = 'Magic Damage +20' } },
        Waist = 'Embla Sash', --5
        Legs = 'Aya. Cosciales +2', --6-bunzi legs here for 20 SIR
        Feet = 'Volte Gaiters', --6
    },
...
profile.HandlePrecast = function()
    local canCast = gcinclude.CheckSpellBailout();
    if (canCast == false) then gFunc.CancelAction() return end
...
profile.HandleMidcast = function()
    ...
    elseif (spell.Skill == 'Singing') then
        ...
        elseif (string.contains(spell.Name, 'Requiem')) or (string.contains(spell.Name, 'Elegy')) or (string.contains(spell.Name, 'Threnody')) or (string.contains(spell.Name, 'Finale')) then
