...
local sets = {
    ...
    BP = {--I/II both cap at 15, the rest need 671 skill total, -10 to both from job gifts
        Ammo = "Epitaph",--II 5
        Head = "Beckoner's Horn +2",
        Neck = "Incanter's Torque",
        Ear1 = "C. Palug Earring",
        ...
        Hands = "Glyphic Bracers +1",--I 6
        Ring1 = "Evoker's Ring",
        Ring2 = "Stikini Ring +1",
        Back = "Conveyance Cape", --II 3
        -- Legs = "Glyphic Spats +1" --I 6
        -- Feet = "Glyph. Pigaches +1", --II 1
    },
    Siphon = {
        Ammo = "Epitaph",
        Head = "Beckoner's Horn +2",
	...
	SmnPhysical = {
        ...
        Feet = "Helios Boots", -- think about replacing these
    },
    SmnPhysical_Hybrid = {},
    SmnPhysical_Acc = {
        Ring1 = "Varar Ring +1",
...
local function HandlePetAction(PetAction)
	...
	elseif (gcinclude.SmnMagical:contains(PetAction.Name)) then
        ...
        if (gcdisplay.GetCycle("MeleeSet") ~= "Default") then
            gFunc.EquipSet("SmnMagical_" .. gcdisplay.GetCycle("MeleeSet")) end
    ...
    elseif (gcinclude.SmnEnfeebling:contains(PetAction.Name)) then
        ...
        if (gcdisplay.GetCycle("MeleeSet") ~= "Default") then
            gFunc.EquipSet("SmnPhysical_" .. gcdisplay.GetCycle("MeleeSet")) end
    end
end
...
profile.HandleAbility = function()
    ...
    if ability.Name == "Astral Flow" then
        gFunc.EquipSet(sets.Astral_Flow)
    else
