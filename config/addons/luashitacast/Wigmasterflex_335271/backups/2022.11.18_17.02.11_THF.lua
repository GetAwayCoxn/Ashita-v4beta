...
-- local sets = T{profile.Sets};
-- sets = sets:merge(gcinclude.sets, false);
...
profile.HandleDefault = function()
	...
	if (gcdisplay.GetToggle('DTset') == true) then
		...
		gFunc.EquipSet(profile.Sets.Dt);
	end
...
profile.HandleItem = function()
	...
	if string.match(item.Name, 'Holy Water') then gFunc.EquipSet(gcinclude.profile.Sets.Holy_Water) end
end
