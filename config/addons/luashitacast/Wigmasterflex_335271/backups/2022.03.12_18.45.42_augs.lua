...
local sets = {
    ...
    augs = {
        Main = 'Tanmogayi',
        Sub = { Name = 'Colada', Augment = { [1] = 'STR+3', [2] = '"Dbl.Atk."+3', [3] = 'Attack+16', [4] = 'Accuracy+10' } },
        Ammo = 'Honed Tathlum',
        Head = { Name = 'Herculean Helm', Augment = { [1] = 'Weapon skill damage +4%', [2] = 'Accuracy+12', [3] = 'Attack+12', [4] = '"Mag. Atk. Bns."+24' } },
        Neck = 'Wiglen Gorget',
