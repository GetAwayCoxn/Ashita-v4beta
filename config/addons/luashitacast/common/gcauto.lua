...
gcauto.AMWeapons = T{--Build this out
...
gcauto.AMWeaponSkills = T{
	['WAR'] = T{relic = 'Scourge', empyrean = 'Ukko\'s Fury', mythic = 'King\'s Justice', aeonic = 'Upheaval'},
	['MNK'] = T{relic = 'Final Heaven', empyrean = 'Victory Smite', mythic = 'Ascetic\'s Fury', aeonic = 'Shijin Spiral'},
	['WHM'] = T{relic = 'Randgrith', empyrean = 'Dagan', mythic = 'Mystic Boon', aeonic = 'Realmrazer'},
	['BLM'] = T{relic = 'Gates of Tartarus', empyrean = 'Mykr', mythic = 'Vidohunir', aeonic = 'Shattersoul'},
	['RDM'] = T{relic = 'Mercy Stroke', empyrean = 'Chant du Cygne', mythic = 'Death Blossom', aeonic = 'Requiescat'},
	['THF'] = T{relic = 'Mercy Stroke', empyrean = 'Rudra\'s Storm', mythic = 'Mandalic Stab', aeonic = 'Exenterator'},
	['PLD'] = T{relic = 'Scourge', empyrean = 'Chant du Cygne', mythic = 'Atonement', aeonic = 'Requiescat'},
	['DRK'] = T{relic = 'Scourge', empyrean = 'Quietus', mythic = 'Insurgency', aeonic = 'Entropy'},
	['BST'] = T{relic = 'Onslaught', empyrean = 'Cloudsplitter', mythic = 'Primal Rend', aeonic = 'Ruinator'},
	['BRD'] = T{relic = 'Mercy Stroke', empyrean = 'Rudra\'s Storm', mythic = 'Mordant Rime', aeonic = 'Exenterator'},
	['RNG'] = T{relic = 'Coronach', empyrean = 'Armageddon', mythic = 'Trueflight', aeonic = 'Last Stand'},
	['SAM'] = T{relic = 'Tachi: Kaiten', empyrean = 'Tachi: Fudo', mythic = 'Tachi: Rana', aeonic = 'Tachi: Shoha'},
	['NIN'] = T{relic = 'Blade: Metsu', empyrean = 'Blade: Hi', mythic = 'Blade: Kamu', aeonic = 'Blade: Shun'},
	['DRG'] = T{relic = 'Geirskogul', empyrean = 'Camlann\'s Torment', mythic = 'Drakesbane', aeonic = 'Stardiver'},
	['SMN'] = T{relic = 'Gates of Tartarus', empyrean = 'Mykr', mythic = 'Garland of Bliss', aeonic = 'Shattersoul'},
	['BLU'] = T{relic = '', empyrean = 'Chant du Cygne', mythic = 'Expiacion', aeonic = 'Requiescat'},
	['COR'] = T{relic = '', empyrean = 'Armageddon', mythic = 'Leaden Salute', aeonic = 'Last Stand'},
	['PUP'] = T{relic = '', empyrean = 'Victory Smite', mythic = 'Stringing Pummel', aeonic = 'Shijin Spiral'},
	['DNC'] = T{relic = '', empyrean = 'Rudra\'s Storm', mythic = 'Pyrrhic Kleos', aeonic = 'Exenterator'},
	['SCH'] = T{relic = '', empyrean = 'Mykr', mythic = 'Omniscience', aeonic = 'Shattersoul'},
	['GEO'] = T{relic = '', empyrean = '', mythic = 'Exudation', aeonic = 'Realmrazer'},
	['RUN'] = T{relic = '', empyrean = '', mythic = 'Dimidation', aeonic = 'Resolution'},
};
...
function gcauto.AutoWS()
	...
	local player = gData.GetPlayer();
	local am = gData.GetBuffCount('Aftermath: Lv.3');
...
function gcauto.DoJobStuff()
	...
	if (player.SubJob == 'SAM') or (player.MainJob == 'SAM') then
		...
		if (hasso <= 0) and (gcdisplay.GetToggle('HASSO') == true) and (gcauto.CheckAbilityRecast('Hasso') <= 0) and (player.Status == 'Engaged') then
